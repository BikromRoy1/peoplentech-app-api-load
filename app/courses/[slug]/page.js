              ...
              <div className='border-[7px] border-[#f3f4f6] rounded-[15px] overflow-hidden bg-white'>
                ...
                <div className='p-4'>
                  <h3 className='mt-1 mb-3'>
                    <span className='text-gray-800 font-bold text-[23px]'>
                      ৳ {course?.offline_discount_price || 0}
                    </span>
                    {course?.offline_discount_price && (
                      <del className='ml-3 font-semibold text-[17px] text-gray-600'>
                ...
                {/* show discount mobile screen in footer */}
                <div className='md:hidden fixed bottom-0 left-0 right-0 bg-gray-100 z-50'>
                  <div className='px-3 py-2'>
                    ...
                    {course?.upcomingBatch?.batch_code ? (
                      <a
                        ...
                        target='_blank'
                      >
                        <button className='bg-primary rounded-md cursor-pointer px-8 py-2 whitespace-nowrap w-full text-white flex items-center justify-center text-md font-semibold capitalize'>
                          Enroll Now
                        </button>
                      </a>
                    ) : (
                  ...
                  <div className='mt-6'>
                    <div className='benefits-bg rounded-xl p-6 overflow-hidden'>
                      ...
                      <div className='mt-1'>
                        ...
                        <Link
                          target='_blank'
                          href={course?.module_download_link}
                        >
