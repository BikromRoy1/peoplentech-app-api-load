...
export const metadata = {
  title: 'Post Graduate & Professional Diploma Programs - PeopleNTech',
  description:
...
const DiplomaCourses = async () => {
  const courses = await getCourses();
  return (
    <div>
      <PageBanner
        title='Post Graduate Diploma Programs'
        subtitle='Post Graduate Diploma Programs'
      />
