              ...
              <div className='bg-[#e5e7eb] custom-shadow px-4 py-7 rounded-lg '>
                <div className='videos-module '>
                  ...
                  <details
                    ...
                    open
                  >
                    <summary className='flex items-center justify-between cursor-pointer bg-white hover:bg-[#f0f8ff] py-[1rem] px-[1.25rem] rounded-[6px]'>
                      <h2 className='font-bold text-[#124265] text-[14px] md:text-[16px]'>
                        Oracle Database-SQL: Practice SQL to be confident in
                        Query{' '}
