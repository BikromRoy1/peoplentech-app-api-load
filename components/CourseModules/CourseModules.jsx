  ...
  return (
    <div className="mt-10 relative">
      <div className="border border-[#dee2e6] rounded-xl p-6">
        <h2 className="mb-5 text-2xl font-semibold capitalize leading-[30px] text-gray-900">
          Course Modules
        </h2>
                ...
                <div>
                  <div className="flex items-center gap-4 mt-[5px]">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-primary text-[9px] md:text-sm font-medium">
                        Class - {module.class || "0"}
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <MdOutlineRequestQuote className="text-primary" />
                      <span className="text-primary text-[9px] sm:text-sm font-medium">
                        Quiz - {module.quiz || "0"}
                      </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <GrDocumentStore className="text-primary" />
                      <span className="text-primary text-[9px] sm:text-sm font-medium">
