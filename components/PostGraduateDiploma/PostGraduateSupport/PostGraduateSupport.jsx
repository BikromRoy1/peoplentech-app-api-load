import './PostGraduateSupport.css';
const PostGraduateSupport = () => {
  return (
    <section className='pb-[80px] pt-[80px] call-to-action'>
      <div className='mx-auto px-4 sm:px-6 container lg:px-8'>
        <div className='grid grid-cols-1 md:grid-cols-12 md:items-center'>
          <div className='md:col-span-10 md:col-start-2'>
            <div className='action-container'>
              <div className=' content  justify-center items-center relative'>
                <div className='mx-auto text-center'>
                  <p className='mb-4 font-siliguri'>
                    যেকোনো সময় আমাদের স্টুডেন্ট অ্যাডভাইজরের সাথে কথা <br />{' '}
                    বলুন নিচের যে কোনো মাধ্যমে।
                  </p>
                  <div className='call-poly font-siliguri'>
                    <a href='#' className='btn btn-cta'>
                      কল করুনঃ +8801762-002444
                    </a>
                    <h6 className='poly-or'>অথবা</h6>
                    <a href='https://piit.com.bd/' target='_blank'>
                      <button className='btn poly-book'>
                        ওয়েবসাইট ভিজিট করুন
                      </button>
                    </a>
                  </div>
...
export default PostGraduateSupport;
